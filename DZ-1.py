...
class Lecturer(Mentor):
    ...
    # Реализация всех операторов сравнения через среднюю оценку
    def __lt__(self, other):
...
# --- Создание экземпляров и проверка ---
...
reviewer_2 = Reviewer('Another', 'Expert')
...
student_2 = Student('Olga', 'Alekhina', 'F')
...
# Проверка функций среднего балла
